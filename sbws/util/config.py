...
def _validate_general(conf):
    ...
    ints = {
        ...
        'number_epochs': {'minimum': 1, 'maximum': None},
        'observation_compute': {'minimum': 1, 'maximum': None},
    }
    floats = {
...
def _validate_paths(conf):
    ...
    unvalidated_keys = [
        ...
        'log_dname', 'observation_file', 'name_authority', 'relays_to_measure_path', 'consensus_file', 'observed_bandwidth', 'estimates_file', 'weight_first', 
        'weight_second', 'weight_third', 'generator', 'par1gc', 'par1mc', 'par1ec', 'par2gc', 'par2mc', 'par2ec', 'lambda', 'mleflowarray_file']
    all_valid_keys = unvalidated_keys
    allow_missing = ['sbws_home', 'par1gc', 'par1mc', 'par1ec', 'par2gc', 'par2mc', 'par2ec', 'lambda', 'mleflowarray_file']
    errors.extend(_validate_section_keys(conf, sec, all_valid_keys, err_tmpl,
